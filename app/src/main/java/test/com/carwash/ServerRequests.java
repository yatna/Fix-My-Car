   ...
   // HttpClient client;
    ...
    public class editUserDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ArrayList<NameValuePair> dataToSend = new ArrayList<>();
            dataToSend.add(new BasicNameValuePair("name", user.name));
            dataToSend.add(new BasicNameValuePair("user_id",Integer.toString(user.id)));
            dataToSend.add(new BasicNameValuePair("address", user.address));
            dataToSend.add(new BasicNameValuePair("password", user.password));
            dataToSend.add(new BasicNameValuePair("phone", user.phone));
    ...
    public class fetchUserDataAsyncTask extends AsyncTask<Void, Void, User> {
        ...
        protected User doInBackground(Void... params) {
           ...
           // StringBuilder url= new StringBuilder(SERVER_ADDRESS);
           // url.append("FetchUserData.php");
           // HttpGet get =new HttpGet(url.toString());
            ...
            try {
                ...
                if (jObject.length() != 0){
                    ...
                    returnedUser = new User(id,name,phone, user.username,
